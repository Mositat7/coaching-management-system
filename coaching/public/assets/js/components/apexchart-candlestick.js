...
(colors = ["#4697ce", "#7dcc93"]),
  (options = {
    ...
    series: [{ name: "حجم", data: seriesDataLinear }],
...
(colors = ["#e06d94", "#7dcc93"]),
  (options = {
    ...
    title: { text: "نمودار شمعی - دسته بندی محور X", align: "left" },
      ...
      custom: [
        ...
        function (e) {
          var t = e.seriesIndex,
            ...
            e = e.w;
          return (
            '<div class="apexcharts-tooltip-candlestick"><div>باز: <span class="value">' +
            e.globals.seriesCandleO[t][a] +
            '</span></div><div>زیاد: <span class="value">' +
            e.globals.seriesCandleH[t][a] +
            '</span></div><div>کم: <span class="value">' +
            e.globals.seriesCandleL[t][a] +
            '</span></div><div>بسته: <span class="value">' +
