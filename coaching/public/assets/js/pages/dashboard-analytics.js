var options = {
    ...
    series: [{ name: "لیست املاک", data: [40, 50, 65, 40, 40, 65, 40] }],
    legend: { show: !1 },
    xaxis: {
...
options = {
  ...
  colors: ["#eef2f7", "#eef2f7", "#604ae3", "#eef2f7"],
  dataLabels: { enabled: !1 },
  series: [{ name: "نمایندگان جدید", data: [40, 50, 65, 40, 40, 65, 40] }],
  legend: { show: !1 },
  xaxis: {
    categories: ["S", "M", "T", "W", "T", "F", "S"],
    axisBorder: { show: !1 },
...
options = {
  ...
  colors: ["#eef2f7", "#eef2f7", "#604ae3", "#eef2f7"],
  dataLabels: { enabled: !1 },
  series: [{ name: "مشتریان جدید", data: [40, 50, 65, 40, 40, 65, 40] }],
  legend: { show: !1 },
  xaxis: {
    categories: ["S", "M", "T", "W", "T", "F", "S"],
    axisBorder: { show: !1 },
...
options = {
  ...
  colors: ["#eef2f7", "#eef2f7", "#604ae3", "#eef2f7"],
  dataLabels: { enabled: !1 },
  series: [{ name: "درآمد", data: [40, 50, 65, 40, 40, 65, 40] }],
  legend: { show: !1 },
  xaxis: {
    categories: ["S", "M", "T", "W", "T", "F", "S"],
    axisBorder: { show: !1 },
  ...
  series: [
    {
      name: "مخارج",
      data: [
        16800, 16800, 15500, 17e3, 14800, 15500, 19e3, 16e3, 15e3, 17e3, 14e3,
        17e3,
      ],
    },
    {
      name: "درآمد",
      data: [
        16500, 17500, 16200, 21500, 17300, 16e3, 16e3, 17e3, 16e3, 19e3, 18e3,
        19e3,
      ],
    },
  ],
...
options = {
  ...
  dataLabels: { enabled: !1 },
  series: [{ name: "املاک فروخته شده", data: [40, 50, 65, 45, 40, 70, 40] }],
  legend: { show: !1 },
  xaxis: {
    categories: ["S", "M", "T", "W", "T", "F", "S"],
    axisBorder: { show: !1 },
