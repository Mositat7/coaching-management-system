...
<!-- Mirrored from www.app.iarsalan.ir/lahomes/admin/agents-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Dec 2025 18:00:29 GMT -->
<head>
  <!-- Title Meta -->
  <meta charset="utf-8"/>
  <title>
   لیست نماینده | لاهومز - الگوی مدیر مدیریت املاک و مستغلات
  </title>
		   ...
		   <tbody>
			<tr>
			 <td>
			  <div class="d-flex align-items-center gap-2">
			   <div>
				<img alt="" class="avatar-sm rounded-circle" src="assets/images/users/avatar-2.jpg"/>
			   </div>
			   <div>
			...
			<tr>
			 <td>
			  <div class="d-flex align-items-center gap-2">
			   <div>
				<img alt="" class="avatar-sm rounded-circle" src="assets/images/users/avatar-3.jpg"/>
			   </div>
			   <div>
				<a class="text-dark fw-medium fs-15" href="#!">
				 نسترن سلطانی
			 ...
			 <td>
			  اصفهان، خیابان ملاصدرا، کوچه ۱۴، پلاک۳۶
			 </td>
			 <td>
			  info@nastaran.com
			 </td>
			...
			<tr>
			 ...
			 <td>
			  اصفهان، بلوار شاهد، کوچه۵، پلاک۲۳
			 </td>
			 <td>
			  info@ilia.com
			 </td>
			...
			<tr>
			 ...
			 <td>
			  اصفهان، خیابان شیخ صدوق، کوچه۱۸، پلاک۷۰
			 </td>
			 <td>
			  info@mahsa.com
			 </td>
			...
			<tr>
			 ...
			 <td>
			  اصفهان، دروازه تهران، کوچه۱، پلاک۱۴
			 </td>
			 <td>
			  info@zahra.com
			 </td>
			...
			<tr>
			 ...
			 <td>
			  اصفهان، خیابان اردیبهشت، کوچه۳، پلاک۱۰
			 </td>
			 <td>
			  info@barbod.com
			 </td>
			...
			<tr>
			 <td>
			  <div class="d-flex align-items-center gap-2">
			   <div>
				<img alt="" class="avatar-sm rounded-circle" src="assets/images/users/avatar-9.jpg"/>
			   </div>
			   <div>
				<a class="text-dark fw-medium fs-15" href="#!">
				 شیرین رضایی
			 ...
			 <td>
			  اصفهان، خیابان نیکبخت، کوچه۱۸، پلاک۲
			 </td>
			 <td>
			  info@shirin.com
			 </td>
