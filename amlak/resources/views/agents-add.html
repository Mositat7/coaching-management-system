...
<!-- Mirrored from www.app.iarsalan.ir/lahomes/admin/agents-add.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Dec 2025 18:00:31 GMT -->
<head>
  <!-- Title Meta -->
  <meta charset="utf-8"/>
  <title>
   اضافه کردن نماینده | لاهومز - الگوی مدیر مدیریت املاک و مستغلات
  </title>
	   ...
	   <div class="card">
		<div class="card-body">
		 <div class="d-flex align-items-center gap-2 border-bottom pb-3">
		  <img alt="" class="avatar-lg rounded-3 border border-light border-3" src="assets/images/users/avatar-2.jpg"/>
		  <div class="d-block">
		 ...
		 <p class="mt-3 d-flex align-items-center gap-2 mb-2">
		  <iconify-icon class="fs-18 text-primary" icon="solar:home-bold-duotone">
		  </iconify-icon>
		  ۲۴۳ ملک
		 </p>
		  ...
		  <div class="col-lg-6">
		   <form>
			<div class="mb-3">
			 ...
			 <input class="form-control" id="agent-name" placeholder="نام و نام خانوادگی" type="text"/>
			</div>
		   </form>
		  </div>
		  <div class="col-lg-6">
		   <form>
			<div class="mb-3">
			 <label class="form-label" for="agent-email">
			  ایمیل نماینده
			 </label>
			 <input class="form-control" id="agent-email" placeholder="ایمیل" type="email"/>
			</div>
		   </form>
		  </div>
		  <div class="col-lg-6">
		   <form>
			<div class="mb-3">
			 <label class="form-label" for="agent-number">
			  شناسه نماینده
			 </label>
			 <input class="form-control" id="agent-number" placeholder="شماره شناسه" type="number"/>
			</div>
		   </form>
		  </div>
		  <div class="col-lg-6">
		   <form>
			<div class="mb-3">
			 <label class="form-label" for="properties-number">
			  شناسه املاک
			 </label>
			 <input class="form-control" id="properties-number" placeholder="شماره شناسه املاک" type="number"/>
			</div>
		   </form>
		  </div>
		  <div class="col-lg-12">
		   <form>
			<div class="mb-3">
			 <label class="form-label" for="agent-address">
			  آدرس نماینده
			 </label>
			 <textarea class="form-control" id="agent-address" placeholder="آدرس" rows="3"></textarea>
			</div>
		   </form>
		  </div>
		  <div class="col-lg-4">
		   <form>
			<div class="mb-3">
			 <label class="form-label" for="agent-zipcode">
			  کد پستی
			 </label>
			 <input class="form-control" id="agent-zipcode" placeholder="کد پستی" type="number"/>
			</div>
		   </form>
		  </div>
		  <div class="col-lg-4">
		  ...
		  <div class="col-lg-4">
		   <form>
			<div class="mb-3">
			 ...
			 <input class="form-control" id="facebook-url" placeholder="لینک" type="url"/>
			</div>
		   </form>
		  </div>
		  <div class="col-lg-4">
		   <form>
			<div class="mb-3">
			 ...
			 <input class="form-control" id="instagram-url" placeholder="لینک" type="url"/>
			</div>
		   </form>
		  </div>
		  <div class="col-lg-4">
