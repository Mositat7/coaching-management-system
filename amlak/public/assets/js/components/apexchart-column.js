var options = {
    ...
    series: [
      { name: "سود خالص", data: [47, 58, 59, 54, 62, 59, 65, 61, 68] },
      { name: "درآمد", data: [79, 86, 103, 97, 89, 107, 93, 116, 96] },
      { name: "جریان نقدی رایگان", data: [38, 42, 39, 28, 47, 50, 54, 55, 43] },
    ],
    xaxis: {
      categories: [
        "اردیبهشت",
...
options = {
  ...
  series: [
    { name: "محصول یک", data: [47, 58, 44, 70, 25, 46, 24, 52] },
    { name: "محصول دو", data: [16, 26, 23, 11, 16, 30, 36, 15] },
    { name: "محصول سه", data: [14, 20, 18, 18, 24, 17, 18, 16] },
  ],
  xaxis: {
    categories: [
      "2011 کیو۱",
...
options = {
  ...
  series: [
    { name: "محصول یک", data: [11, 17, 15, 15, 21, 14, 15, 13] },
    { name: "محصول دو", data: [44, 55, 41, 67, 22, 43, 21, 49] },
    { name: "محصول سه", data: [13, 23, 20, 8, 13, 27, 33, 12] },
  ],
  xaxis: {
    categories: [
      "2011 کیو۱",
...
options = {
  ...
  legend: {
    ...
    customLegendItems: ["اصلی", "مورد انتظار"],
...
var optionsGroup = {
    ...
    tooltip: {
      x: {
        formatter: function (e) {
          return "کیو" + dayjs(e).quarter() + " " + dayjs(e).format("YYYY");
        },
      },
    },
  },
...
options = {
  ...
  yaxis: { title: { text: "وعده های غذایی" } },
  fill: {
    type: "gradient",
    gradient: {
      shade: "light",
...
options = {
  ...
  plotOptions: {
    bar: {
      colors: {
        ranges: [
          { from: -100, to: -46, color: "#ff86c8" },
          { from: -45, to: 0, color: "#7f56da" },
        ],
      },
      columnWidth: "80%",
    },
...
options = {
  chart: { height: 380, type: "rangeBar", toolbar: { show: !1 } },
...
(colors = ["#4697ce", "#53389f", "#7f56da", "#ff86c8", "#e06d94", "#63b7e6"]),
  (options = {
    ...
    title: { text: "نتیجه سالانه", offsetX: 15 },
    subtitle: { text: "(برای مشاهده جزئیات روی نوار کلیک کنید)", offsetX: 15 },
    yaxis: { labels: { show: !1 } },
  });
(chart = new ApexCharts(
...
var optionsQuarter = {
    ...
    yaxis: { labels: { show: !1 } },
    title: { text: "نتیجه فصلی", offsetX: 10 },
    tooltip: {
      x: {
        formatter: function (e, t) {
