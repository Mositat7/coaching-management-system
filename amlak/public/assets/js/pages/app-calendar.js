class CalendarSchedule {
  ...
  onEventClick(e) {
    this.formEvent?.reset(),
      ...
      (this.modalTitle.text = "ویرایش رویداد"),
      this.modal.show(),
  ...
  onSelect(e) {
    this.formEvent?.reset(),
      ...
      (this.modalTitle.text = "افزودن رویداد جدید"),
      this.modal.show(),
  ...
  init() {
    ...
    e = [
      {
        title: "مصاحبه - مهندس بک‌اند",
        start: e,
        end: e,
        className: "bg-primary",
      },
      {
        title: "ملاقات با تیم سی تی",
        start: new Date(Date.now() + 13e6),
        end: e,
        className: "bg-warning",
      },
      {
        title: "ملاقات با آقای رهنما",
      ...
      {
        title: "صفحه نمایش تلفن - مهندس فرانت‌اند",
